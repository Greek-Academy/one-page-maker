...
function Edit() {
  ...
  const initialUserState = useAppSelector(state => state.user);
  ...
  const onAuthorClick = (user: string) => updateDocumentState("contributors", user.split(',')); 
  const onReviewerClick = (user: string) => updateDocumentState("reviewers", user.split(',')); 
      ...
      <div>
        ...
        <div className="flex justify-between">
          <span>
            ...
            <UserItem user={initialUserState} onClick={onAuthorClick}/>
            <input className="reviewers" type="text" value={documentData?.reviewers} onChange={onChangeReviewers}></input>
            <UserItem user={initialUserState} onClick={onReviewerClick}/>
          </span>
          <span>
