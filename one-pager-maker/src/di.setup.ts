...
export const setupDIRepository = () => {
  ...
  container.register(DI.ViewHistoryRepository, {
    useClass: ViewHistoryRepositoryImpl
  });

  container.register(DI.DocumentRepository, {
...
export const setupDIService = () => {
  ...
  container.register(DI.ViewHistoryService, {
    useClass: ViewHistoryServiceImpl
  });
